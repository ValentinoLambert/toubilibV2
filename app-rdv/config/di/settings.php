...
return [
    ...
    // Practitioners service API settings
    'praticiens.api_base_uri' => $_ENV['PRATICIENS_API_BASE_URI'] ?? 'http://app-praticiens',
    'praticiens.api_timeout' => (float)($_ENV['PRATICIENS_API_TIMEOUT'] ?? 5.0),
